...
public class POISearch {
    ...
    POISearch() {
        ...
        mMarkers[MDEFAULT] = new MarkerSymbol(drawableToBitmap(
                ContextCompat.getDrawable(App.activity, R.drawable.pin)),
                HotspotPlace.BOTTOM_CENTER);

        mMarkers[MFLICKR] = new MarkerSymbol(drawableToBitmap(
                ContextCompat.getDrawable(App.activity, R.drawable.marker_poi_flickr)),
                HotspotPlace.BOTTOM_CENTER);

        mMarkers[MPICASA] = new MarkerSymbol(drawableToBitmap(
                ContextCompat.getDrawable(App.activity, R.drawable.marker_poi_picasa_24)),
                HotspotPlace.BOTTOM_CENTER);

        mMarkers[MWIKI16] = new MarkerSymbol(drawableToBitmap(
                ContextCompat.getDrawable(App.activity, R.drawable.marker_poi_wikipedia_16)),
                HotspotPlace.BOTTOM_CENTER);

        mMarkers[MWIKI32] = new MarkerSymbol(drawableToBitmap(
                ContextCompat.getDrawable(App.activity, R.drawable.marker_poi_wikipedia_32)),
                HotspotPlace.BOTTOM_CENTER);
    }
